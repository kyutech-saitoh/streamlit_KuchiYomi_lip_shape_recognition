...
target_person_id = st.selectbox("select target model", ("P05", "P00", "P01", "P02", "P03", "P04", "P05", "P08", "P09", "P11", "P12",
...
class VideoProcessor:
    ...
    def recv(self, frame):
        ...
        cv2.ellipse(out_image, ((image_width//2, image_height//2), (image_width//4, image_height//4), 0), (255, 255, 255))
